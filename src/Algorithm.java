...
import util.Destroy_and_Repair_Pool;
import util.LS_Operator_Pool;
...
public class Algorithm {
    ...
    private void AILS() {
        ...
        IterPerStage = MyParameter.N_ITER_PER_STAGE;
        ...
        do {
            ...
            while (IterationCounter < IterPerStage) {
                ...
                if (NewStage) {
//                    System.out.println("get into new stage => " + (System.nanoTime() - start_time) / 1e9);
...
//                x_BestThisStage = new Solution(x_current);
